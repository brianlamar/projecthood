...
<!-- STORY OF TRANSFORMATION (video) -->
<section class="section bg-bg">
  <div class="wrap" style="text-align:center;">
    <div class="eyebrow" style="color:var(--red);">A Story of Transformation</div>
    <h2>This is what change looks like.</h2>
    <p style="max-width:620px;margin:10px auto 28px;color:var(--muted);">Real lives, real transformation — straight from our community on the South Side.</p>
    <div style="display:flex;justify-content:center;">
      <div style="width:100%;max-width:340px;aspect-ratio:340/735;border-radius:12px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,.18);background:#000;">
        <iframe src="https://www.facebook.com/plugins/video.php?height=735&href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1375823754382160%2F&show_text=false&width=340&t=0" style="border:none;overflow:hidden;width:100%;height:100%;" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
      </div>
    </div>
  </div>
</section>
